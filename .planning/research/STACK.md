...
**Project:** Seedance 2.0 ComfyUI Plugin (AIHubMix API)
...
pip install requests>=2.28 opencv-python>=4.7 Pillow>=9.0
...
**Note:** Do not pin torch or numpy versions. ComfyUI manages these. Only declare libraries that ComfyUI does not already provide.
